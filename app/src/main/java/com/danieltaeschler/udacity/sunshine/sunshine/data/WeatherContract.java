...
public class WeatherContract {
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "com.danieltaeschler.udacity.sunshine.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //The location setting used to find the current city for weather forecast
